...
namespace unused_field {
    ...
    public:
        [[maybe_unused]] [[nodiscard]] char getTest14() const {
            return _test1_4;
        }

        [[maybe_unused]] void setTest14(char test14) {
            _test1_4 = test14;
        }
    };
    ...
    struct [[maybe_unused]] test13 {
        ...
        [[maybe_unused]] static int fn(test13* t) {
            return t->_test13_1;
        };
        [[maybe_unused]] [[nodiscard]] int fn2() const {
            return this->_test13_2;
        };
    };
